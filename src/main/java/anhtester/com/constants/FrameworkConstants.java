...
public final class FrameworkConstants {
    ...
    public static final String PATH_TO_APP_FILE = PropertiesHelpers.getValue("PATH_TO_APP_FILE");
    public static final String DEVICE_NAME = PropertiesHelpers.getValue("DEVICE_NAME");
    public static final String IP = PropertiesHelpers.getValue("IP");
    public static final String APPIUMURL = PropertiesHelpers.getValue("APPIUMURL");
